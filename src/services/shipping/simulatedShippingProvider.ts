/**
 * Cotação simulada de frete (regras atuais do negócio).
 * NÃO remove regras existentes. Substituição por Melhor Envio/J3 reais
 * exige credenciais e cobertura oficiais — ver shippingService.ts.
 */
...
/** Preços fixos simulados por UF — não são cotação Melhor Envio ao vivo. */
...
export function quoteSimulatedShipping(
...
export const simulatedShippingProvider = {
  quote: quoteSimulatedShipping,
  isJ3CepEligible,
